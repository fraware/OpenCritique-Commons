...
required = [
    ...
    "docs/openreviewer-space-import.md",
    "docs/private-evaluation-pilot.md",
    "docs/adapter-authoring.md",
    "docs/runner-plugins.md",
    "docs/deferred-document-intelligence.md",
    "docs/deferred-verifiers.md",
    "docs/deferred-hosted-ops.md",
    "docs/deferred-expert-scale.md",
    ...
    "SECURITY.md",
    "src/opencritique_runners/protocol.py",
    "src/opencritique_registry/live_import.py",
    "templates/adapter-skeleton/adapter.py",
    "governance/evidence/natural-adjudication-staffing.json",
    "governance/evidence/natural-adjudication-staffing.schema.json",
    "corpus/matcher-audit/README.md",
    "scripts/live_pipeline_demo.sh",
    "scripts/live_pipeline_demo.ps1",
    "scripts/docker-entrypoint.sh",
    ".github/workflows/live-coarse-smoke.yml",
